...
export function ConverterGridCard({ converter }: ConverterGridCardProps) {
  return (
    <Link
      ...
      className="image-converter-row group flex h-full flex-col rounded-xl border border-border bg-surface p-4 transition-[border-color,transform] hover:-translate-y-0.5 hover:border-scanonix-orange/35 sm:p-5"
    >
      ...
      <span className="mt-4 inline-flex items-center gap-1 text-sm font-medium text-foreground-muted transition-colors group-hover:text-scanonix-orange">
        Open tool
