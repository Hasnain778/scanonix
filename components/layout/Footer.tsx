        ...
        <div className="grid gap-10 lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-4">
            ...
            <a
              ...
              className="home-btn-interactive mt-6 inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.03] px-4 py-2.5 text-sm font-medium text-white transition-colors hover:border-scanonix-orange/35 hover:bg-scanonix-orange/5"
            >
