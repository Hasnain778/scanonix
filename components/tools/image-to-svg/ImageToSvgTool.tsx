          ...
          file ? (
            <div className="overflow-hidden rounded-2xl border border-border bg-surface shadow-[var(--shadow-soft)]">
              ...
              {/*
                ...
                Explicit pl/pr (not px+pr) so right clearance is not overridden by axis padding.
              */}
              <div className="bg-surface-muted/30 pb-3 pl-3 pr-24 pt-3 sm:pb-4 sm:pl-4 sm:pr-36 sm:pt-4 lg:pr-4">
                {hasResult && resultPreviewUrl ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-scanonix-muted">
                      Best results come from illustrations, graphics and flat artwork.
                    </p>
                  </div>
                ) : null}
              </div>
        ...
        controlPanel={
          file ? (
            hasResult && resultBlob && stats ? (
              <aside
                aria-label="Image to SVG result"
              ...
              >
                {/*
                  ...
                  Use pl/pr (not px+pr) so Tailwind axis padding cannot clobber pr-*.
                */}
                <div className="min-h-0 flex-1 space-y-2.5 overflow-y-auto overscroll-contain py-3 pl-3.5 pr-24 sm:py-3 sm:pl-4 sm:pr-36 lg:pl-4 lg:pr-4">
                  <div>
              ...
              <ToolControlPanel
                aria-label="Image to SVG controls"
                footer={
                  <div className="flex flex-col gap-2">
                    <p className="text-[11px] leading-snug text-scanonix-muted">
                      Best for illustrations, graphics and flat artwork. Photos may look
                      noisy.
                    </p>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-3 text-sm text-scanonix-muted">
                      Convert images into real SVG vector paths.
                    </p>
                  </div>
