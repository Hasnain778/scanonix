...
export const HOMEPAGE_TOOLS: HomepageTool[] = [
  ...
  },
  {
    id: "image-to-svg",
    name: "Image to SVG",
    shortDescription: "Convert images into real SVG paths.",
    description:
      "Convert illustrations, graphics and simple artwork into real SVG vector paths.",
  ...
  },
  {
    ...
    shortDescription: "Convert rasters to SVG with tracing controls.",
    description:
      "Convert raster images to SVG with control over colors, detail, smoothing and background handling.",
