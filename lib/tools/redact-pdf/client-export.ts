/**
 * Browser-only secure export entry for the Redact PDF client workspace (Phase 125C).
 * Uses the same 125B hybrid rasterization engine without Node-only dependencies.
 */
...
import { applyAcroFormRedactionPolicy } from "./acroform-policy";
import { rasterizeRedactedPage } from "./rasterize-page.browser";
import type {
...
export async function exportRedactedPdfFromWorkspace(
  originalBytes: ArrayBuffer,
